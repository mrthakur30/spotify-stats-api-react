...
function TopArtists() {
  ...
  const {topArtistsWeek , topArtistsMonth , topArtistsYear} =   useSelector(state=>state.home);
  const duration =  [topArtistsWeek , topArtistsMonth , topArtistsYear];
  return(
  <div className='h-full'>
           <div className="py-4 px-4 md:px-8 flex flex-col items dark:bg-gray-900">
      <ul
        role="tablist"
